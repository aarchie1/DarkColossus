class CrossProjectile {
  constructor(game, x, y, target) {
    ...
    this.animations[0] = new Animator(ASSET_MANAGER.getAsset("./Sprites/Boss/boss_body.png"), 0, 0, 256, 256, 8, 0.05, 0, true);
  ...
  updateBB() {
    this.lastBB = this.BB;
    this.BB = new BoundingBox(this.x - 20, this.y, 256, 256);
  }
  update() {
